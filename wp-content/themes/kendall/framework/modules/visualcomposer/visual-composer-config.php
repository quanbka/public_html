...
if ( ! function_exists('kendall_elated_configure_visual_composer') ) {
	/**
	 * Configuration for Visual Composer
	 * Hooks on vc_after_init action
	 */
	function kendall_elated_configure_visual_composer() {
	...
	add_action('vc_after_init', 'kendall_elated_configure_visual_composer');

}


if ( ! function_exists('kendall_elated_configure_visual_composer_grid_elemets') ) {
	...
	function kendall_elated_configure_visual_composer_grid_elemets() {
	...
	add_action('vc_after_init', 'kendall_elated_configure_visual_composer_grid_elemets');
}


if ( ! function_exists('kendall_elated_configure_visual_composer_frontend_editor') ) {
	/**
	 * Configuration for Visual Composer FrontEnd Editor
	 * Hooks on vc_after_init action
	 */
	function kendall_elated_configure_visual_composer_frontend_editor() {
	...
	add_action('vc_after_init', 'kendall_elated_configure_visual_composer_frontend_editor');
}
...
if ( class_exists( 'WPBakeryShortCodesContainer' ) ) {
	...
	class WPBakeryShortCode_Eltd_Price_List extends WPBakeryShortCodesContainer {}
...
/*** Row ***/
if ( ! function_exists('kendall_elated_vc_row_map') ) {
	/**
	 * Map VC Row shortcode
	 * Hooks on vc_after_init action
	 */
	function kendall_elated_vc_row_map()
	{

		$animations = array(
			esc_html__('No animation', 'kendall') => '',
			esc_html__('Elements Shows From Left Side' , 'kendall')	=>	'eltd-element-from-left',
			esc_html__('Elements Shows From Right Side', 'kendall')	=> 	'eltd-element-from-right',
			esc_html__('Elements Shows From Top Side', 'kendall')	=>	'eltd-element-from-top',
			esc_html__('Elements Shows From Bottom Side', 'kendall')	=>	'eltd-element-from-bottom',
			esc_html__('Elements Shows From Fade', 'kendall')		=>	'eltd-element-from-fade'
		);

		vc_add_param('vc_row', array(
			'type' => 'dropdown',
			'class' => '',
			'heading' => esc_html__('Row Type', 'kendall'),
			'param_name' => 'row_type',
			'value' => array(
				esc_html__('Row', 'kendall') => 'row',
				esc_html__('Parallax', 'kendall') => 'parallax'
			)
		));
		...
		vc_add_param('vc_row', array(
			'type' => 'dropdown',
			'class' => '',
			'heading' => esc_html__('Content Width', 'kendall'),
			'param_name' => 'content_width',
			'value' => array(
				esc_html__('Full Width', 'kendall') => 'full-width',
				esc_html__('In Grid', 'kendall') => 'grid',
			)
		));
		...
		vc_add_param('vc_row', array(
			'type' => 'dropdown',
			'class' => '',
			'heading' => esc_html__('Header Style', 'kendall'),
			'param_name' => 'header_style',
			'value' => array(
				esc_html__('Default', 'kendall') => '',
				esc_html__('Light', 'kendall') => 'eltd-light-header',
				esc_html__('Dark', 'kendall') => 'eltd-dark-header',
			),
		...
		vc_add_param('vc_row', array(
			'type' => 'textfield',
			'class' => '',
			'heading' => esc_html__('Anchor ID', 'kendall'),
			'param_name' => 'anchor',
			'value' => '',
			'description' => esc_html__('For example "home"', 'kendall')
		));
		vc_add_param('vc_row', array(
			'type' => 'dropdown',
			'class' => '',
			'heading' => esc_html__('Content Aligment', 'kendall'),
		...
		vc_add_param('vc_row', array(
			'type' => 'dropdown',
			'class' => '',
			'heading' => esc_html__('Video Background', 'kendall'),
			'value' => array(
				esc_html__('No', 'kendall') => '',
				esc_html__('Yes', 'kendall') => 'show_video'
			),
			'param_name' => 'video',
			'description' => '',
		...
		vc_add_param('vc_row', array(
			'type' => 'dropdown',
			'class' => '',
			'heading' => esc_html__('Video Overlay', 'kendall'),
			'value' => array(
				esc_html__('No', 'kendall') => '',
				esc_html__('Yes', 'kendall') => 'show_video_overlay'
			),
		...
		vc_add_param('vc_row', array(
			'type' => 'attach_image',
			'class' => '',
			'heading' => esc_html__('Video Overlay Image (pattern)', 'kendall'),
			'value' => '',
		...
		vc_add_param('vc_row', array(
			'type' => 'textfield',
			'class' => '',
			'heading' => esc_html__('Video Background (webm) File URL', 'kendall'),
			'value' => '',
		...
		vc_add_param('vc_row', array(
			'type' => 'textfield',
			'class' => '',
			'heading' => esc_html__('Video Background (mp4) file URL', 'kendall'),
			'value' => '',
		...
		vc_add_param('vc_row', array(
			'type' => 'textfield',
			'class' => '',
			'heading' => esc_html__('Video Background (ogv) file URL', 'kendall'),
			'value' => '',
		...
		vc_add_param('vc_row', array(
			'type' => 'attach_image',
			'class' => '',
			'heading' => esc_html__('Video Preview Image', 'kendall'),
			'value' => '',
		...
		vc_add_param("vc_row", array(
			'type' => 'dropdown',
			'class' => '',
			'heading' => esc_html__('Full Screen Height', 'kendall'),
		...
		vc_add_param('vc_row', array(
			'type' => 'dropdown',
			'class' => '',
			'heading' => esc_html__('Vertically Align Content In Middle', 'kendall'),
		...
		vc_add_param('vc_row', array(
			'type' => 'textfield',
			'class' => '',
			'heading' => esc_html__('Section Height', 'kendall'),
		...
		vc_add_param('vc_row', array(
			'type' => 'attach_image',
			'class' => '',
			'heading' => esc_html__('Parallax Background image', 'kendall'),
			'value' => '',
			'param_name' => 'parallax_background_image',
			'description' => esc_html__('Please note that for parallax row type, background image from Design Options will not work so you should to fill this field', 'kendall'),
			'dependency' => Array('element' => 'row_type', 'value' => array('parallax'))
		));
		...
		vc_add_param('vc_row', array(
			'type' => 'textfield',
			'class' => '',
			'heading' => esc_html__('Parallax speed', 'kendall'),
		...
		vc_add_param('vc_row', array(
			'type' => 'dropdown',
			'heading' => esc_html__('CSS Animation', 'kendall'),
		...
		vc_add_param('vc_row', array(
			'type' => 'textfield',
			'heading' => esc_html__('Transition delay (ms)', 'kendall'),
        ...
        vc_add_param('vc_row', array(
            'type' => 'dropdown',
            'heading' => esc_html__('Set background image in center','kendall'),
            'param_name' => 'center_bck_image',
            'value' => array(
                esc_html__('No' , 'kendall') => 'no',
                esc_html__('Yes' , 'kendall') => 'yes',
            ),
		...
		vc_add_param('vc_row_inner', array(
			...
			'class' => '',
			'heading' => esc_html__('Vertically Align Content In Middle', 'kendall'),
			'param_name' => esc_html__('vertically_align_content_in_middle', 'kendall'),
			'value' => array(
				esc_html__('No', 'kendall') => 'no',
				esc_html__('Yes', 'kendall') => 'yes'
			),
	...
	add_action('vc_after_init', 'kendall_elated_vc_row_map');
}
