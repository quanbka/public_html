...
use KendallElated\Modules\Header\Types;
/**
...
class HeaderFactory {
    ...
    public function validHeaderObject($header_object = null) {
        ...
        return is_subclass_of($header_object, 'KendallElated\Modules\Header\Lib\HeaderType');
    }
        ...
        if($headerType !== '') {
            switch($headerType) {
                case 'header-vertical':
                    ...
                    break;
                case 'header-dual':
                    $this->headerObject = new Types\HeaderDual();
                    break;
