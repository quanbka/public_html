<?php
namespace KendallElated\Modules\Shortcodes\GoogleMap;
...
class GoogleMap implements ShortcodeInterface{
	...
	public function vcMap() {
		...
		vc_map(
			array(
				'name' => esc_html__('Elated Google Map', 'kendall'),
				'base' => $this->base,
				...
				'params' => array(
					array(
						'type' => 'textfield',
						'heading' => esc_html__('Address 1','kendall'),
						'param_name' => 'address1',
						'admin_label' => true
					),
					array(
						'type' => 'textfield',
						'heading' =>esc_html__( 'Address 2','kendall'),
						'param_name' => 'address2',
						'admin_label' => true,
					...
					array(
						'type' => 'textfield',
						'heading' => esc_html__('Address 3','kendall'),
						'param_name' => 'address3',
						'admin_label' => true,
					...
					array(
						'type' => 'textfield',
						'heading' => esc_html__('Address 4','kendall'),
						'param_name' => 'address4',
						'admin_label' => true,
					...
					array(
						'type' => 'textfield',
						'heading' =>esc_html__( 'Address 5','kendall'),
						'param_name' => 'address5',
						'admin_label' => true,
					...
					array(
						'type' => 'dropdown',
						'heading' => esc_html__('Custom Map Style','kendall'),
						'param_name' => 'custom_map_style',
						'value' => array(
							esc_html__('No','kendall') => 'false',
							esc_html__('Yes','kendall') => 'true'
						),
						'save_always' => true,
						'description' => esc_html__('Enabling this option will allow Map editing','kendall')
					),
					array(
						'type' => 'colorpicker',
						'heading' => esc_html__('Color Overlay','kendall'),
						'param_name' => 'color_overlay',
						'description' => esc_html__('Choose a Map color overlay','kendall'),
						'dependency' => Array('element' => 'custom_map_style', 'value' => array('true'))
					),
					array(
						'type' => 'textfield',
						'heading' => esc_html__('Saturation','kendall'),
						'param_name' => 'saturation',
						'description' => esc_html__('Choose a level of saturation (-100 = least saturated, 100 = most saturated)','kendall'),
						'dependency' => Array('element' => 'custom_map_style', 'value' => array('true'))
					),
					array(
						'type' => 'textfield',
						'heading' => esc_html__('Lightness','kendall'),
						'param_name' => 'lightness',
						'description' =>esc_html__( 'Choose a level of lightness (-100 = darkest, 100 = lightest)','kendall'),
						'dependency' => Array('element' => 'custom_map_style', 'value' => array('true'))
					),
					array(
						'type' => 'attach_image',
						'heading' => esc_html__('Pin','kendall'),
						'param_name' => 'pin',
						'description' => esc_html__('Select a pin image to be used on Google Map','kendall')
					),
					array(
						'type' => 'textfield',
						'heading' => esc_html__('Map Zoom','kendall'),
						'param_name' => 'zoom',
						'description' => esc_html__('Enter a zoom factor for Google Map (0 = whole worlds, 19 = individual buildings)','kendall')
					),
					array(
						'type' => 'dropdown',
						'heading' => esc_html__('Zoom Map on Mouse Wheel','kendall'),
						...
						'save_always' => true,
						'description' => esc_html__('Enabling this option will allow users to zoom in on Map using mouse wheel','kendall')
					),
					array(
						'type' => 'textfield',
						'heading' => esc_html__('Map Height','kendall'),
	...
	public function render($atts, $content = null) {
		...
		$html = kendall_elated_get_shortcode_module_template_part('templates/google-map-template', 'google-map', '', $params);
