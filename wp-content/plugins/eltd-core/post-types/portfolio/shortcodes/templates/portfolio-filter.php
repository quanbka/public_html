<div class = "eltd-portfolio-filter-holder <?php echo esc_attr($masonry_filter)?>">
	<div class = "eltd-portfolio-filter-holder-inner">
		...
		<ul>
			...
			<?php } else{ ?>
				<li data-class="filter_<?php print $rand_number ?>" class="filter_<?php print $rand_number ?>" data-filter="*"><span><?php  print __('All', 'eltd_core')?></span></li>
			<?php } ?>
			<?php foreach($filter_categories as $cat){				
				...
				<?php }else{ ?>
					<li data-class="filter_<?php print $rand_number ?>" class="filter filter_<?php print $rand_number ?>" data-filter = ".portfolio_category_<?php print $cat->term_id  ?>">
						<span>
							<?php print $cat->name ?>
						</span>
					</li>
