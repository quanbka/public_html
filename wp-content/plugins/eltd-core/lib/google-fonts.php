<?php
if ( ! function_exists( 'kendall_elated_init_google_fonts_array' ) ) {
	function kendall_elated_init_google_fonts_array() {

		global $kendall_elated_fonts_array;
		$kendall_elated_fonts_array =
			array(
				0   =>
					array(
	...
	add_action( 'after_setup_theme', 'kendall_elated_init_google_fonts_array' );
}